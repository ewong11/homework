...
public class BST
{
  ...
  //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    TreeNode search(TreeNode currNode, int target) {
      if (currNode.getValue() == target) { //if value is at currNode, return that pointer
        return currNode;
      }
      /**************************************************
      check if the value is greater or less than currNode
      to decide to recurse left or right
      ***************************************************/
      else if (target < currNode.getValue()){
        search(currNode.getLeft(), target);
      }
      else {
        search(currNode.getRight(), target);
      }
