...
public class LList<T> implements List<T>
{
  ...
  public Iterator<T> iterator() {
    Iterator<T> MyIterator = new MyIterator();
    return MyIterator;
  }
  ...
  private class MyIterator implements Iterator<T>
  {
    ...
    public void remove()
    {
      ...
      if ( ! _okToRemove ) //to make sure _dummy will always point to a node
      ...
      //two else ifs are necessary
      //check if you are remocing from the first or last node
      ...
      //if we are removing last node
	    ...
	    //if we are removing any other element
      //this itself doesnt iterate through, it just removes
	    else {
        _dummy.getNext().setPrev(_dummy.getPrev());
        _dummy.getPrev().setNext(_dummy.getNext());
        //what problems coild _dummy=_dummy.getNext() cause?
          }
